...
| 4 | [Поиск изображений по описанию](ImageSearch)                             | Разработатка алгоритма поиска изображений по текстовому описанию                                   | Python, Pandas, NumPy, Scikit-learn, PyTorch, BERT, CLIP           |
