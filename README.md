...
| 5 | [Выявление токсичных комментариев](CommentsClassifier)                             | Разработка алгоритма выявления токсичных комментариев                                   | Python, Pandas, NumPy, Scikit-learn, LightGBM, PyTorch, BERT, re, Matplotlib, Seaborn           |
